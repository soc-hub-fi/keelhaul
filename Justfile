...
build:
    PATH_SVD=../data/tackle.svd cargo build --bin register-selftest-generator-runner

run:
    PATH_SVD=../data/tackle.svd PATH_JSON=../temp/parsed.json PATH_OUTPUT=src/register_tests.rs cargo run --bin register-selftest-generator-runner
